...
def quote_send_sh_job():
    print
    'a simple cron job start at', datetime.datetime.now()


# schedudler.start()
# 上面通过装饰器定义了cron
# job，可以通过函数scheduler.add_cron_job添加，用装饰器更方便。Scheduler构造函数中传入daemonic参数，表示执行线程是非守护的，在Schduler的文档中推荐使用非守护线程
#
...
> db.jobs.findOne()
{
    ...
    "max_runs": null,
    "trigger": BinData(0,
                       ""),
